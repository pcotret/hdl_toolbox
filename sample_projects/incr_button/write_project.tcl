...
set files [list \
 [file normalize "${origin_dir}/src/Button.vhd"]\
 [file normalize "${origin_dir}/src/Timer.vhd"]\
 [file normalize "${origin_dir}/src/Toggle.vhd"]\
 [file normalize "${origin_dir}/src/TopModule.vhd"]\
]
...
set file "[file normalize ${origin_dir}/src/zedboard.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "src/zedboard.xdc"
